...
The inspiration for the name came the outdoor image used, with the entrance door appearring as if it's under the arch, albeit on the far side of the canel as well as the arch image taken from FontAwesome.
